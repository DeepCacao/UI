...
export default function Features() {
  return (
    <section className='grid min-h-[calc(100vh-5rem)] md:h-[calc(100vh-5rem)] grid-cols-1 md:grid-cols-12 md:grid-rows-6 gap-4'>

      <div className='col-span-1 md:col-span-8 md:row-start-1'>
      ...
      <div className='col-span-1 md:col-span-4 md:row-start-3 flex flex-col gap-4'>
